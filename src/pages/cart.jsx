        ...
        <div className="lg:col-span-2">
          <div className="space-y-4">
            ...
            {cartItems.map((item) => (
              <div
                key={item.id}
                className="flex gap-4 p-6 bg-[#f9f9f9] rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300"
              >
          ...
          <button
            onClick={() => navigate(-1)}
            className="mt-8 text-black hover:text-black/70 transition-colors font-semibold"
          >
            ← Continue Shopping
          </button>
        </div>
