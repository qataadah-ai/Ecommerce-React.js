        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-6 max-w-xs">
              Premium fashion for those who appreciate beauty in the details.
              Sustainably crafted, thoughtfully delivered.
            </p>
            {/* Socials */}
            <div className="flex gap-3">
              {socials.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.name}
                  className="w-9 h-9 rounded-xl bg-white/10 hover:bg-[var(--text)] flex items-center justify-center transition-colors duration-200"
                >
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-8 lg:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            {payments.map((p) => (
              <span
                key={p}
                className="bg-white/10 text-white/50 text-[9px] font-bold px-2 py-1 rounded tracking-wide uppercase"
              >
                {p}
              </span>
            ))}
